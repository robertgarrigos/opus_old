...
<body>
    <div class="error-template">
	    ...
	    <div class="error-actions">
			...
			<a href="mailto:{{ config('opus.mail_sender_address') }}" class="btn btn-default" style="font-family: 'Open Sans'; height: 45px; line-height: 45px; text-decoration: none; font-size: 18px; border-radius: 4px; width: 200px; text-align: center; font-weight: 400; padding: 0; box-shadow: 0px 5px 0px #d0d0d0; background-color: #f1f1f1; border: none;">
